...
namespace Bluejam.Utils.DatabaseScripter.Domain.Entities
{
    public class Script : Entity
    {
        ...
        [DomainSignature]
        [Validators.NotNullNotWhiteSpace]
        ...
        public Values.Version CurrentVersion { get; protected set; }

        /// <summary>
        /// Gets or sets the new version.
        /// </summary>
        /// <value>The new version.</value>
        public Values.Version NewVersion { get; protected set; }
        ...
        public override string ToString()
        {
            ...
            return String.Format(CultureInfo.InvariantCulture, "Script \"{0}\": Increment database from {1} to {2}",
                Name,
