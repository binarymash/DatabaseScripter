...
namespace Bluejam.Utils.DatabaseScripter.Domain.Strategies
{
    public abstract class DatabaseAdapter : IDisposable
    {
        ...
        /// <returns></returns>
        public abstract bool ConfirmVersion(string databaseName, Values.Version version, out bool confirmed);
        ...
        /// <param name="version">The version.</param>
        /// <returns></returns>
        public abstract bool SetVersion(string databaseName, Values.Version version);
