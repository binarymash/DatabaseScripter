...
namespace Bluejam.Utils.DatabaseScripter.SystemTests
{
    ...
    [TestFixture]
    public class TestManifestNotFound : TestBase
    {
        ...
        {
            base.SetUp();
            ConfigFileFactory.SetUpConfig("Bluejam.Utils.DatabaseScripter.exe.config", "Bluejam.Utils.DatabaseScripter.SystemTests.Files.ManifestNotFound.config");
        }
