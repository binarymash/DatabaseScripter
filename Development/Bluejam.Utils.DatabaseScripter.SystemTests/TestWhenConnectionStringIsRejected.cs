...
namespace Bluejam.Utils.DatabaseScripter.SystemTests
{
    ...
    public class TestWhenConnectionStringIsRejected : AbstractTestBase
    {
        ...
        public void Run()
        {
            ...
            Assert.AreEqual(Domain.Interfaces.ErrorCode.DatabaseAdapterFailureAtConnect, RunApplication(exeFile.FullName, "--environment=SystemTest --scripts=create,\"increment to 0.0.0.1\",\"insert sample data\""));
