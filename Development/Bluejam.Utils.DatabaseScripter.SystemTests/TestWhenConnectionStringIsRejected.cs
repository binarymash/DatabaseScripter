...
namespace Bluejam.Utils.DatabaseScripter.SystemTests
{
    ...
    public class TestWhenConnectionStringIsRejected : AbstractTestBase
    {
        ...
        {
            base.SetUp();
            ConfigFileFactory.SetUpConfig("Bluejam.Utils.DatabaseScripter.exe.config", "Bluejam.Utils.DatabaseScripter.SystemTests.Files.Config.InvalidConnectionString.config");
        }
        ...
        public void Run()
        {
            ...
            Assert.AreEqual(ErrorCode.DatabaseAdapterFailureAtConnect, RunApplication(exeFile.FullName));
