...
namespace Bluejam.Utils.DatabaseScripter.SystemTests
{
    ...
    public class TestWhenDatabaseAdapterDoesNotExist : AbstractTestBase
    {
        ...
        public void Run()
        {
            ...
            Assert.AreEqual(Domain.Interfaces.ErrorCode.FailedToInitialiseComponents, RunApplication(exeFile.FullName, "--environment=SystemTest --scripts=create,\"increment to 0.0.0.1\",\"insert sample data\""));
