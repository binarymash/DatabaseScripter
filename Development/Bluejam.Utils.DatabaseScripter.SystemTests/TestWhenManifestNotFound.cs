...
namespace Bluejam.Utils.DatabaseScripter.SystemTests
{
    ...
    public class TestWhenManifestNotFound : AbstractTestBase
    {
        ...
        {
            base.SetUp();
            ConfigFileFactory.SetUpConfig("DatabaseScripter.exe.config", "Bluejam.Utils.DatabaseScripter.SystemTests.Files.Config.ManifestNotFound.config");
        }
        ...
        public void Run()
        {
            ...
            Assert.AreEqual(Domain.Interfaces.ErrorCode.CouldNotFindManifest, RunApplication(exeFile.FullName, "--environment=SystemTest --scripts=create"));
