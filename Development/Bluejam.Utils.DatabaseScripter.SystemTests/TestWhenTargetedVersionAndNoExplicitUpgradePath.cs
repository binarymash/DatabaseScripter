...
{
    [TestFixture]
    public class TestWhenTargetedVersionAndNoExplicitUpgradePath : AbstractTestBase
    {
        ...
        public void Run()
        {
            ...
            Assert.AreEqual(Domain.Interfaces.ErrorCode.NoExplicitUpgradePath, RunApplication(exeFile.FullName, "--environment=SystemTest -t=0.0.0.5"));
            dbAsserter.AssertThatDatabaseExists();
            dbAsserter.AssertThatIncrement0_0_0_1HasNotBeenApplied();
            dbAsserter.AssertThatIncrement0_0_0_2HasNotBeenApplied();
            dbAsserter.AssertThatSchemaVersionIs0_0_0_0();
